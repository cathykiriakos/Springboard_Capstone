...
#Data Manipulations needed: 
 First we will melt the data and create a new data frame with all 3 years of data summed by expense code, activiy code, and account number.  We wil first filter the data set, and then melt and cast the data to obtain sums by expense code, activity code, and account number:
```{r,subset_data}
...
```
Final data prep step to cast the data: 
```{r, cast}
